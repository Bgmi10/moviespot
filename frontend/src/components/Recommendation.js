...
const theme = useSelector(store => store.theme.toggletheme)
  ...
  return (
  <div >
   {!data ? <p className='text-gray-400 ml-[120px] font-bold'>Loading...</p>  : <div className='l '>
         <h2 className={theme ? "text-2xl font-mono  text-gray-300 mb-4 ml-4  mt-2 " : "text-2xl font-mono  text-gray-700 mb-4 ml-4 mt-2 "}>{Recommendations}</h2>
        <Slider {...settings} >
         {
