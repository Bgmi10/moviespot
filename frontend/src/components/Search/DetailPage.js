...
const DetailPage = ({ data, loader, error }) => {
 ...
 return (
  <> 
   {loader ? <div className="h-screen"><Loader loading={loader} /></div> : ( 
    <div>  
        ...
        <div className="relative  inset-0 ease-in-out shadow-lg rounded-lg text-white" >
          ...
          >
            <div className="lg:flex lg:py-0">
              <img
                src={posterimg()}
                className={`mb-2 rounded-3xl duration-500 ml-5 transition-transform h-auto lg:w-[400px] sm: w-32`}
                style={{
                  zIndex: 10,
                }}
                alt=""
             ...
             <div className="px-5">
                ...
                <div className='flex gap-2 lg:mb-8 sm: mb-4'>
                ...
                <div className={theme ? 'text-gray-300 sm: grid lg:flex lg:gap-2 sm: grid-cols-2 sm: gap-3' : 'text-gray-700 lg:flex p-2'}>
                  {data?.[0]?.type === "movies" && <>
                   <div className={"sm: px-6 sm: py-3 lg:py-4 lg:px-10 lg:text-xl text-center lg:w-auto rounded-lg flex bg-rose-500 items-center gap-1 cursor-pointer hover:bg-rose-700"} onClick={handlePlayVideo}>
                      <span className='font-bold'>Play</span>
                      <FontAwesomeIcon icon={faPlay} className='mt-1'/>
                     </div>
                     <a
                        href={
                         `https://drive.google.com/uc?export=download&id=${extractDriveId(data?.[0]?.drivePreviewUrl?.[0]?.url)}`
                        }
                        className="sm: px-6 sm: py-3 lg:px-10 lg:py-4 lg:text-xl rounded-lg flex lg:ml-2 lg:w-auto bg-gradient-to-r from-rose-500 to-indigo-600 font-bold text-white hover:bg-indigo-700 transition duration-300"
                     >
                       Download HD
                     </a>
                     </>
                    ...
                    <button
                      className={"bg-red-600 hover:bg-red-700 lg:py-4 sm: px-6 sm: py-3 lg:px-10 lg:text-xl lg:w-auto rounded-lg flex lg:ml-2 text-white font-bold"}
                      onClick={handleshowfeedbackform}
                    >
                    <FontAwesomeIcon icon={faStar} className='text-yellow-300 mt-1 m-1' /> Rate Now
                    </button>
                    <button
                      className={"bg-blue-500 hover:bg-blue-600 lg:py-4 sm: px-6 sm: py-3 lg:px-10 lg:text-xl rounded-lg lg:w-auto flex lg:ml-2 text-white font-bold"}
                      onClick={handleshareclick}
                    >
                      Share <ShareIcon className='mt-[3px]'/>
                    </button>
                      </div>
                 <div>
               </div>
