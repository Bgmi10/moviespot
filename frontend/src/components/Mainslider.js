            ...
            <div className="min-h-full sm: h-[600px]">
              ...
              /> */}
               <img
                ...
                alt=""
              />
              <div className="absolute inset-0 bg-black   bg-opacity-60  flex sm: px-4 sm: py-[118px] lg:px-[115px] lg:py-36  transition-all duration-100 0 " style={{
    backgroundImage: 'linear-gradient(to top, rgba(0, 0, 0, 0.7) 20%, rgba(0, 0, 0, 0) 50%)'
                ...
                /> */}
                 <img
                  ...
                  className={`mb-2 rounded-lg  duration-1000 lg:h-80  sm: h-40 ml-5  transition-transform ${animating ? 'transform scale-50 opacity-0' : 'transform opacity-100'}`}
                  alt=""
                />
                <div className="px-5 ">
                <h1 className={`text-white lg:text-5xl font-bold sm: text-2xl transition-transform duration-1000 ${animating ? 'transform -translate-y-full opacity-0' : 'transform translate-y-0 opacity-100'}`}>
                     {  i.name || i.title || i.movieName}
                     </h1>


                
                  <p className={`text-gray-100 sm: text-[8px] py-4 w-1/2  lg:text-[11px] transition-transform duration-1000 font-extralight ${animating ? 'transform -translate-y-full opacity-0' : 'transform translate-y-0 opacity-100'}`}>
                    {i.overview || i.storyline}
                  </p>
                  <div className='mt-3'>
                  <span className={` border-2 rounded-md  lg:p-[8px] sm: p-[4px] text-white transition-transform duration-1000  items-center  ${animating ? ' transform -translate-y-full opacity-0' :  'transform translate-y-0 opacity-100'}`}>
                    Play Now
